                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 pl-xl-0 pl-lg-0 pl-md-0 border-left m-b-30">
                                        <div class="product-details">
                                            <div class="border-bottom pb-3 mb-3">
                                                <h2 class="mb-3"><input type="text" name="nomProduit" placeholder="Nom du Produit"/></h2>
                                                <span style="color: red">@error('nomProduit'){{$message}}@enderror</span>
                                                <h3 class="mb-0 text-primary">$<input type="text" name="prixProduit" placeholder="Prix du Produit"></h3>
                                                <span style="color: red">@error('prixProduit'){{$message}}@enderror</span>
                                            </div>
                                            <div class="product-size border-bottom">
                                                <h4>Fournisseur</h4>
                                                <input type="text" name="fournisseurProduit" placeholder="Fournisseur">
                                                <div class="product-qty">
                                                    <h4>Quantité</h4>
                                                    <div class="quantity">
                                                        <input type="number" name="quantiteProduit" placeholder="1" >
                                                    </div>
                                            ...
                                            <textarea rows="4" cols="50" placeholder="Allo"></textarea>
                                            <a href="liste"><input class="btn btn-primary btn-block btn-lg" type="submit" value="Sauvegarder"></a>
                                        </div>
                                        @error('title')
